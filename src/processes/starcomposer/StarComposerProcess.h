...
#ifndef __StarComposerProcess_h
#define __StarComposerProcess_h
...
class StarComposerProcess : public MetaProcess
{
public:
...
PCL_BEGIN_LOCAL
extern StarComposerProcess* TheStarComposerProcess;
PCL_END_LOCAL
